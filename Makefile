...
.PHONY: all php56 php70 php71 php72 php73 pho74 php80 tag_latest release

all: php56 php70 php71 php72 php73 php80
...
php82:
	docker build -t $(NAME):8.1 --rm -f Dockerfile-8.2 .
